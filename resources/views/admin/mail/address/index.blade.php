...
@section('contents')
    <div class="sub-contents">
        ...
        <div class="text-right">
            <a href="{{ route('mail.address.upsert') }}" class="btn btn-small btn-type1 color-type20 call-popup" data-popup_name="address-upsert" data-width="900" data-height="350">
                주소록 등록
            </a>
        </div>
            ...
            <table class="cst-table list-table">
                ...
                @forelse($list as $row)
                    <tr data-sid="{{ $row->sid }}">
                        ...
                        <td>
                            <a href="{{ route('mail.address.upsert', ['sid' => $row->sid]) }}" class="btn-admin call-popup" data-popup_name="address-upsert" data-width="900" data-height="350">
